 ...
 * @param {string} [url='https://avnu.fi'] - Optional URL for the Paymaster service. Defaults to 'https://avnu.fi'.
 * @returns {Object} An object containing the status, loading state, and error message.
 */
export const fetchPaymasterStatus = async (network: 'mainnet' | 'sepolia', url: string = 'https://avnu.fi') => {
